...
const NewRegisterGuestForm = React.memo(({ className, onClickRegister }) => {
    ...
    <div className={styles.form}>
      <form className={className} onSubmit={handleRegisterGuest}>
        <h1 className={styles.title}>
          Vui lòng nhập số điện thoại <br /> trước khi dùng thử
        </h1>
        ...
        <div className={styles.btn_wrapper}>
          <Button className={styles.btn} color="white" type="submit">
            Đăng Ký
          </Button>
        </div>
      </form>
...
export default NewRegisterGuestForm;
