...
import { NewAuthModal, NewSignUpForm } from 'components/mocules';
...
const NewSignUpModal = React.memo((props) => {
  ...
  return (
    <NewAuthModal visible={visible} className={className} onClose={onClose} title="Đăng ký Thành viên" width="30rem" height="100%">
      <NewSignUpForm hasAlert={hasAlert} onClickSignIn={onChangeSignIn} isLoading={isLoading} referCode={referCode} onClickSignUp={handleSignUp} />
    </NewAuthModal>
  );
});
