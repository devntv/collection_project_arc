...
const SellerTabsV2 = ({ slug, isFlagship, isCustom = false }) => {
  ...
  return (
    <div className={isFlagship ? styles.tabs : styles.tabsSeller}>
      <Grid container>
        <Grid item xs={12} md={6} lg={6}>
          <Box className={styles.groupLink}>
            ...
            {user && !isCustom && (
              <LinkComp replace className={styles.link} href={!isFlagship ? `/seller/${slug}/rewards` : linkRewards}>
