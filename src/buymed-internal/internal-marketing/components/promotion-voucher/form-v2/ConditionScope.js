...
import { combinationCondition, conditionMap, defaultCombinationCondition, defaultCondition } from "../constant";
...
const defaultProductTagCondition = {
    sellerCode: null,
    tagCode: null,
    minQuantity: 1,
    minTotalPrice: 0,
...
const defaultCustomerCondition = {
    minOrderCount: null,
    minDayNoOrder: null,
    maxOrderCount: null
}
...
export default function ConditionScope(props) {
    ...
    useEffect(() => {
        // setCombinationType(conditionItem.combinationType === defaultCombinationCondition.and)
    ...
    useEffect(() => {
        switch (conditionItem.conditionType) {
            case defaultCondition.product:
                if (promotionType === "GIFT" && conditionItem.combinationType === defaultCombinationCondition.or) {
    ...
    useEffect(() => {
        if (promotionType === "GIFT" && conditionItem.conditionType === defaultCondition.product) {
