import { Typography, Grid, TextField, IconButton, Tooltip, InputAdornment, FormHelperText } from '@material-ui/core'
...
export default function OrderConditionSlot(props) {
    ...
    const { control, errors, register, getValues, setValue, setError, clearErrors } = hookForm
